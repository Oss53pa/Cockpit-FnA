...
const dashboards = [
  ...
  { id: 'endettement', route: '/dashboard/endettement', name: 'Endettement & Dette financière ★', desc: 'Gearing, capacité de remboursement, ICR/DSCR, composition LT/CT et coût de la dette bancaire', icon: 'Landmark', cat: 'Standard' },
  { id: 'dupont', route: '/dashboard/dupont', name: 'Analyse DuPont (ROE) ★', desc: 'Décomposition de la rentabilité financière : ROE = marge nette × rotation de l\'actif × levier financier', icon: 'Network', cat: 'Standard' },
  ...
  // ─── Tables & Vues de données (T01-T10) ─────────────────────────
  { id: 'ana_t01', route: '/analytical/journal',                name: 'T01 — Journal analytique',          desc: 'Liste des ventilations par écriture · filtres période/journal/branche · pagination · drill-down compte',                                                  icon: 'BookOpen',     cat: 'Analytique' },
  { id: 'ana_t02', route: '/analytical/balance',                name: 'T02 — Balance analytique par axe',  desc: 'Soldes par code analytique sur la période · filtres axe/branche · totaux débit/crédit/solde · export CSV',                                                  icon: 'Calculator',   cat: 'Analytique' },
  { id: 'ana_t03', route: '/analytical?tab=wbs',                name: 'T03 — Compte de Résultat par Projet', desc: 'P&L détaillé par projet · CA / Achats / Marge brute / Charges directes / Marge nette · vue WBS',                                                          icon: 'GitMerge',     cat: 'Analytique' },
  { id: 'ana_t04', route: '/analytical/pivot',                  name: 'T04 — Tableau croisé multi-axes',   desc: 'Pivot dynamique entre 2 dimensions au choix (axe × mois × compte × branche × journal) · export Excel',                                                     icon: 'Grid3x3',      cat: 'Analytique' },
  { id: 'ana_t05', route: '/analytical?tab=codes',              name: 'T05 — Registre des codes analytiques', desc: 'Référentiel des codes par axe · hiérarchie parent · branche WBS · statut · création/édition manuelle',                                                  icon: 'FolderKanban', cat: 'Analytique' },
  { id: 'ana_t06', route: '/analytical?tab=rules',              name: 'T06 — Règles de mapping analytique', desc: 'Règles d\'affectation automatique · priorité · simulation · application en masse · couverture',                                                            icon: 'Wand2',        cat: 'Analytique' },
  { id: 'ana_t07', route: '/analytical?tab=dashboard',          name: 'T07 — Suivi Budget vs Réalisé',     desc: 'Comparaison Budget/Réalisé/Écart par code analytique · période · drill-down · alertes seuils',                                                              icon: 'BarChart3',    cat: 'Analytique' },
  { id: 'ana_t08', route: '/analytical/fg-allocation',          name: 'T08 — Refacturations analytiques',  desc: 'Écritures de refacturation FG → Projets · clé de répartition · % par clé · périodes (Phase 2)',                                                            icon: 'GitBranch',    cat: 'Analytique' },
  { id: 'ana_t09', route: '/analytical/anomalies',              name: 'T09 — Anomalies analytiques',       desc: 'Détection automatique : écritures sans ventilation · code inactif · incohérence branche WBS · doublons',                                                    icon: 'AlertOctagon', cat: 'Analytique' },
  { id: 'ana_t10', route: '/analytical/audit-trail',            name: 'T10 — Audit Trail analytique',      desc: 'Historique consolidé des imports (axes/codes) et affectations · filtres par type · export CSV',                                                              icon: 'ClipboardList', cat: 'Analytique' },
  // ─── Catalogue KPIs (Sprint 2) ──────────────────────────────────
  { id: 'ana_kpis', route: '/analytical/kpis',                  name: 'Catalogue KPIs analytiques (70+)',  desc: '70+ KPIs structurés en 9 catégories : Pilotage / Qualité / Projets / Centres coût/revenu / Ressources / FG / Budget / IA',                                  icon: 'Activity',     cat: 'Analytique' },
